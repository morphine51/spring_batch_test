...
@Component
@Slf4j
public class OneStepListener extends StepExecutionListenerSupport{
    ...
    public ExitStatus afterStep(StepExecution stepExecution) {
    	...
    	if(stepExecution.getStatus() == BatchStatus.FAILED) {
    		...
    		log.debug("exceptionStepName: {}", stepExecution.getJobExecution().getExecutionContext().get("exceptionStepName"));         
